...
1. Retrieve script from GitHub `wget -O serverpilot-scripts.sh https://raw.githubusercontent.com/webdna/serverpilot-scripts/master/serverpilot-scripts.sh?token=AAQQ1cdmy90VlwUHQGey3QOiAiKiUuLCks5Yt-uvwA%3D%3D`
